    ...
    <ul class="navbar-nav ms-auto  d-flex flex-row">
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('cart.index')); ?>">
                ...
                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('reservations.index')); ?>">
                ...
                <li><a class="dropdown-item d-flex align-items-center" href="<?php echo e(route('gift-cards.index')); ?>">
    ...
    <!-- Reports Dropdown -->
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <?php endif; ?>
                <?php if(auth()->user()->hasPermission(config('constants.role_modules.list_sites_management.value'))): ?>
                <li><a class="dropdown-item" href="<?php echo e(route('admin.whitelist')); ?>">
...
<?php /**PATH C:\herd\pos.kayuta\resources\views/layouts/partials/navbar.blade.php ENDPATH**/ ?>