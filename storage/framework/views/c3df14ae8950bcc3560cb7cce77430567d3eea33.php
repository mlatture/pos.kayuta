        ...
        <form id="dateRangeForm">
          <div class="firstpage-modal">
            <div class="form-row mb-3">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="fromDate"><?php echo e($dictionaryFields['cid'] ?? 'Check In Date'); ?></label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="toDate"><?php echo e($dictionaryFields['cod'] ?? 'Check Out Date'); ?></label>
            ...
            <div class="form-row mb-3">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="siteclass"><?php echo e($dictionaryFields['rigtype'] ?? 'Site Type'); ?></label>
            ...
            <div class="form-row mb-3" id="forRv">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="riglength"><?php echo e($dictionaryFields['riglength'] ?? 'Rig Length'); ?></label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="hookup"><?php echo e($dictionaryFields['hookup'] ?? 'Hookup'); ?></label>
          ...
          <div class="secondpage-modal" style="display: none;">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="number_of_guests"><?php echo e($dictionaryFields['num_guests'] ?? 'Number of Guests'); ?></label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="siteId"><?php echo e($dictionaryFields['siteid'] ?? 'Site'); ?></label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="siteLock"><?php echo e($dictionaryFields['sitelock'] ?? 'Site Lock'); ?> ($20)</label>
