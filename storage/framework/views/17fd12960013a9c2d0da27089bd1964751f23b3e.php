...
<?php $__env->startSection('title', 'Payment Report Management'); ?>
<?php $__env->startSection('content-header', 'Payment Report Management'); ?>
    ...
    <div class="row animated fadeInUp">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo route('reports.paymentReport'); ?>" method="GET">
                    <div class="row mt-3">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($order->formattedTotal() ?? 0); ?></td>
                                        <td><?php echo e($order->formattedReceivedAmount() ?? 0); ?></td>
                                        <td><?php echo e((intval($order->total()) > intval($order->receivedAmount())) ? (floatval($order->total()) - floatval($order->receivedAmount())) : 0); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\THOMAS JON\OneDrive\Desktop\pos.kayuta\resources\views\reports\payment-report.blade.php ENDPATH**/ ?>