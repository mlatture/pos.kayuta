...
<?php $__env->startSection('content-header', 'Create Admin'); ?>
...
unset($__errorArgs, $__bag); ?>" id="name"
                        placeholder="Enter admin name"  required value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="phone" placeholder="Enter your phone number" required value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                        id="email" placeholder="Enter your email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                           id="password" placeholder="Enter your password" value="<?php echo e(old('password')); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="admin_role_id" id="admin_role_id" required>
                        ...
                        <?php $__currentLoopData = $adminRoles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $adminRole): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($adminRole->id); ?>"><?php echo e($adminRole->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\THOMAS JON\OneDrive\Desktop\pos.kayuta\resources\views\admin\create.blade.php ENDPATH**/ ?>