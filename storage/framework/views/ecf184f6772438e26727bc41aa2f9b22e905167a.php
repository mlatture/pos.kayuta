...
<head>
  ...
  <script>
    window.baseURL = '<?php echo e(url(request()->path())); ?>';
...
<script>
  new Vue({
    ...
    data: {
      ...
      sendingEvent: false,
      autoRefresh: true,
      refreshInterval: <?php echo e($refreshInterval); ?>,
      refreshTicker: null,
      chart: null,
      pusher: null,
      app: null,
      apps: <?php echo json_encode($apps, 15, 512) ?>,
      form: {
        channel: null,
        event: null,
        data: {},
    ...
    methods: {
      connect () {
        ...
        this.pusher = new Pusher(this.app.key, {
          ...
          wsPort: <?php echo e($port); ?>,
          wssPort: <?php echo e($port); ?>,
      ...
      subscribeToAllChannels () {
        <?php echo json_encode($channels, 15, 512) ?>.forEach(channelName => this.subscribeToChannel(channelName))
      },

      subscribeToChannel (channel) {
        this.pusher.subscribe(`<?php echo e($logPrefix); ?>${channel}`)
...
<?php /**PATH C:\Users\THOMAS JON\OneDrive\Desktop\pos.kayuta\vendor\beyondcode\laravel-websockets\resources\views\dashboard.blade.php ENDPATH**/ ?>