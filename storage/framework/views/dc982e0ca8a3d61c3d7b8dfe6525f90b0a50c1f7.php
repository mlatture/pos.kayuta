...
<?php $component = App\View\Components\Forms\Input::resolve(['label' => 'First name','inputId' => 'f_name','inputName' => 'f_name','value' => old('f_name'),'errors' => $errors->get('f_name'),'placeholder' => 'Enter First Name','required' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal30600fd1d86901c8d1e2118fb7bb2cb7e3d1570f = $component; } ?>
<?php $component = App\View\Components\Forms\Input::resolve(['label' => 'Email','inputId' => 'email','inputName' => 'email','value' => old('email'),'errors' => $errors->get('email'),'placeholder' => 'Enter Email','required' => true,'type' => 'email'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Input::class))->getConstructor()): ?>
...
<?php endif; ?>
                    ...
                    <?php if (isset($component)) { $__componentOriginal30600fd1d86901c8d1e2118fb7bb2cb7e3d1570f = $component; } ?>
<?php $component = App\View\Components\Forms\Input::resolve(['label' => 'Password','inputId' => 'password','inputName' => 'password','value' => old('password'),'errors' => $errors->get('password'),'placeholder' => 'Enter Password','required' => true,'type' => 'password'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('forms.input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Forms\Input::class))->getConstructor()): ?>
...
</div><?php /**PATH C:\Users\THOMAS JON\OneDrive\Desktop\pos.kayuta\resources\views\cart\modals\user-add-modal.blade.php ENDPATH**/ ?>