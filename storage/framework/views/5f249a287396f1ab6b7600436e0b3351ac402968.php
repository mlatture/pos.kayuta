...
<?php $__env->startSection('content-actions'); ?>
    <a href="<?php echo e(route('admin-roles.create')); ?>" class="btn btn-success"><i class="fas fa-plus"></i> Add New Admin Role</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php $__currentLoopData = $adminRole->module_access; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $access): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="row">
                                                        <div class="col">
                                                            <?php if(isset(config('constants.role_modules')[$access])): ?>
                                                                <?php echo e(config('constants.role_modules')[$access]['name']); ?>
                                            ...
                                            <td>
                                                <span class="created_at"><?php echo e($adminRole->created_at->format('m/d/Y')); ?></span>
                                            </td>
                                            <td>
                                                <a href="<?php echo e(route('admin-roles.edit',$adminRole->id)); ?>" class="btn btn-primary"><i
                                                        class="fas fa-edit"></i></a>
                                                <form action="<?php echo e(route('admin-roles.destroy',$adminRole->id)); ?>" method="post" class="d-inline" >
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\THOMAS JON\OneDrive\Desktop\pos.kayuta\resources\views\admin-roles\index.blade.php ENDPATH**/ ?>