...
class CampgroundMapsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        if (!preg_match('/INSERT INTO `campground_maps` \(([^)]+)\) VALUES/is', $sql, $columnsMatch)) {
        ...
        foreach ($rows[1] as $row) {
            ...
            $exists = DB::table('campground_maps')
                ->where('image', $data['image'] ?? null)
        ...
        $this->command->info('Campground Maps table seeded successfully!');
    }
}
