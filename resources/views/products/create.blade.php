            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                           id="name" placeholder="Enter product name" value="{{ old('name') }}" minlength="3"
                ...
                <div class="form-group">
                    <label for="category_id">{{ $dictionaryFields['category_id'] ?? 'Category' }}</label>
                ...
                <div class="form-group">
                    <label for="image">{{ $dictionaryFields['image'] ?? 'Product Image' }}</label>
