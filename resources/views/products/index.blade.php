                                    ...
                                    @foreach ($products as $k => $product)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                src="{{ $product->image && file_exists(base_path('shared_storage/products/' . $product->image)) ? url('shared_storage/products/' . $product->image) : asset('images/product-thumbnail.jpg') }}"
