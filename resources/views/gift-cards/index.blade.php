        ...
        <div class="card-body">
            <table class="table table-hover table-responsive">
                ...
                <tr>
                    <th>ID</th>
                    {{-- <th>Title</th> --}}
                    <th>{{ $dictionaryFields['user_email'] ?? 'User Email' }}</th>
                    <th>{{ $dictionaryFields['barcode'] ?? 'Barcode' }}</th>
                    {{-- <th>Discount Type</th> --}}
                    <th>{{ $dictionaryFields['amount'] ?? 'Amount' }}</th>
                    {{-- <th>Start Date</th> --}}
                    <th>{{ $dictionaryFields['expire_date'] ?? 'Expiry Date' }}</th>
                    {{-- <th>Minimum Purchase</th>
                <th>Maximum Discount</th>
                <th>Limit</th> --}}
                    <th>{{ $dictionaryFields['status'] ?? 'Status' }}</th>
                    <th>{{ $dictionaryFields['created_at'] ?? 'Created At' }}</th>
                    <th>{{ $dictionaryFields['modified_by'] ?? 'Modified By' }}</th>
                    <th>Actions</th>
                </tr>
                </thead>
                <tbody>
