                    ...
                    <form action="{{ route('articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="5"
                                placeholder="Evergreen content...">{{ old('description', $article->description) }}</textarea>
                        </div>
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Click the box to replace image. Ideal ratio 1:1 (e.g., 500x500px)</small>
                            </div>
