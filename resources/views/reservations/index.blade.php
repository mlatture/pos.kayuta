                        ...
                        <div style="height: 400px; overflow-y: auto;">
                            <table class="table table-striped table-hover align-middle mb-0" id="reservationTable">
                                <thead class="table-light">
                                    <tr>
                                        <th style="min-width: 150px;">{{ $dictionaryFields['fname'] ?? 'Name' }}</th>
                                        <th style="min-width: 150px;">{{ $dictionaryFields['siteid'] ?? 'Site' }}</th>
                                        <th style="min-width: 150px;">{{ $dictionaryFields['rigtype'] ?? 'Type' }}</th>

                                        <th style="min-width: 100px;">{{ $dictionaryFields['status'] ?? 'Status' }}</th>
